...
- Drove architectural direction and full-stack development for an AI enterprise insights agent within an 11-engineer team; one of two engineers dedicated full-time to the platform
...
- Hand-selected as part of a new team to build a new cutting edge AI platform to unify all of the companies AI experiences into one app
- Modernized frontend architecture using React, Vite, Tailwind, shadcn/ui, React Query, and Vite federated modules to enable modularity and independent feature delivery
- Evaluated, prototyped, and integrated emerging third-party AI platforms to continuously expand product capabilities at the leading edge of applied AI
...
- Partnered with Staff Engineer to set long-term platform architecture and engineering standards adopted beyond the immediate group
